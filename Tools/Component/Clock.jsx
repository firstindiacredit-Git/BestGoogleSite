      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-[#28283a] rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="relative p-6">
            ...
            <h1 className="text-4xl font-bold text-center text-black dark:text-gray-200">
              Clock
            </h1>
          </div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
              ...
              <div className="relative w-64 h-64 rounded-full bg-gradient-to-br from-blue-50 to-gray-100 border-4 border-white shadow-xl">
                ...
                {[...Array(12)].map((_, i) => (
                  <div
                    key={i}
                    className="absolute w-full h-full text-lg font-bold text-gray-700 dark:text-gray-300"
                    style={{
              ...
              <div className="text-center lg:text-left">
                <div className="text-6xl font-bold mb-4 font-mono tracking-wider text-gray-800 dark:text-gray-200">
                  {formatTime(currentTime)}
                </div>
                <div className="text-2xl text-gray-600 mb-8 dark:text-gray-400">
                  {formatDate(currentTime)}
                </div>

                {/* Location Info */}
                <div className="bg-gray-50 dark:bg-[#513a7a]/50 rounded-xl p-6 space-y-3 shadow-md">
