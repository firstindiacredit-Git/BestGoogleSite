          ...
          <div className="p-4 relative">
            ...
            <div className="grid gap-3 max-w-xl mx-auto">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-3">
                <label className="block dark:text-white text-gray-700 text-base font-semibold mb-1">
                  Enter Text
                </label>
                <textarea
                  value={text}
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-3 text-center">
                  <h2 className="text-sm font-semibold dark:text-white text-gray-700 mb-1">
                    Words
                  </h2>
              ...
              <div className="flex justify-center">
                <button
                  onClick={() => setText("")}
                  className="px-4 py-2 bg-gray-600 dark:bg-red-500 text-white text-sm font-semibold rounded-lg hover:bg-gray-700 transition-colors duration-200"
                >
                  Clear Text
                </button>
              </div>
