        ...
        <div className="bg-white dark:bg-[#513a7a] rounded-lg shadow-lg py-2">
          ...
          <div className="p-6">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white text-center mb-8">
              {isBinaryToDecimal ? "Binary to Decimal" : "Decimal to Binary"}{" "}
              Converter
            </h1>
            ...
            <div className="space-y-6">
              ...
              {/* Result Section */}
              <div className="bg-white dark:bg-[#28283a] dark:text-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <div className="flex justify-center gap-4">
                <button
                  onClick={handleClear}
                  className="inline-flex items-center px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  <svg
                ...
                <button
                  onClick={handleSwap}
                  className="inline-flex items-center px-4 py-2 bg-blue-600 dark:bg-gray-800 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  <svg
                    className="w-5 h-5 mr-2"
                    fill="none"
              ...
              <div className="bg-white dark:bg-[#28283a] rounded-2xl p-6 shadow-sm border border-gray-100">
                <h2 className="text-xl font-bold mb-4 text-center text-gray-800 dark:text-white">
                  How it Works
                </h2>
                      ...
                      {isBinaryToDecimal ? (
                        <>
                          <p className="text-gray-600 dark:text-white mb-2">
                            Binary numbers use only 0s and 1s. Each position
                            represents a power of 2.
                          </p>
                          <div className="inline-block bg-white dark:bg-[#28283a] rounded-lg px-4 py-2 shadow-sm">
                        ...
                        <>
                          <p className="text-gray-600 dark:text-white mb-2">
                            Decimal numbers are converted to binary by dividing
                            by 2 and tracking remainders.
                          </p>
                          <div className="inline-block bg-white dark:bg-[#28283a] rounded-lg px-4 py-2 shadow-sm">
                            <p className="font-mono text-gray-800 dark:text-white">
