          ...
          <div className="p-4 sm:p-6 md:p-8">
            ...
            <form onSubmit={handleSubmit} className="mb-6 sm:mb-8">
              ...
              <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4">
                <button
                  type="submit"
                  className="px-4 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 rounded-xl bg-white dark:bg-[#513a7a] text-white text-base sm:text-lg font-medium transition-all duration-200 hover:bg-blue-700 hover:shadow-md"
                >
