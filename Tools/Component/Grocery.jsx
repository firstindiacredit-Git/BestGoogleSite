...
const Grocery = () => {
  ...
  const handleDownload = () => {
    let listText = groceries
      .map((grocery) => `Item: ${grocery.name}, Quantity: ${grocery.quantity}`)
      .join("\n");
    ...
    <div className="min-h-screen bg-blue-100 dark:bg-[#513a7a] p-2 sm:p-4 md:p-8">
            ...
            <form onSubmit={handleSubmit} className="mb-6 sm:mb-8">
              <div className="grid md:grid-cols-2 gap-4 mb-4">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl  bg-gray-600 dark:text-gray-300 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                  />
                </div>
                <div className="relative">
                  <input
              ...
              <div className="flex items-center gap-4 mb-6">
                <button
                  ...
                  className="px-4 sm:px-6 py-2.5 sm:py-3 bg-white dark:bg-[#513a7a] dark:text-white rounded-xl shadow-sm text-gray-700 hover:from-blue-100 hover:to-gray-200 transition-all flex items-center gap-2"
                >
                  <svg
              ...
              <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4">
                <button
                  type="submit"
                  className="px-4 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 rounded-xl bg-gray-600 dark:bg-[#513a7a] text-white text-base sm:text-lg font-medium transition-all duration-200 hover:bg-blue-700 hover:shadow-md"
                >
                ...
                {groceries.length > 0 && (
                  <button
                    ...
                    className="px-4 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 rounded-xl bg-gray-600 dark:bg-[#513a7a] text-white text-base sm:text-lg font-medium transition-all duration-200 hover:bg-gray-700 hover:shadow-md"
                  >
                    Download List
                  </button>
                )}
              ...
              {groceries.length === 0 ? (
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {groceries.map((grocery, index) => (
                    <div
                      key={index}
                      className="bg-gray-50 dark:bg-gray-700 rounded-xl shadow-sm p-4 flex items-center gap-4 group hover:shadow-md transition-all"
                    >
                      {grocery.image && (
                        <img
                          src={grocery.image}
                          alt={grocery.name}
                          className="w-16 h-16 object-contain rounded-xl dark:bg-gray-600 p-2 shadow-sm"
                        />
                      )}
      ...
      {isImageModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-[#513a7a] rounded-2xl shadow-lg p-6 max-w-2xl w-full">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 gap-4">
              {groceryImages.map((grocery, index) => (
                <div
                  ...
                  className="aspect-square dark:bg-[#28283a] flex items-center justify-center p-2 hover:shadow-lg rounded-xl overflow-hidden cursor-pointer hover:ring-2 ring-blue-500 ring-offset-2 transition-all"
                >
                  <img
                    src={grocery.image}
                    alt={grocery.name}
