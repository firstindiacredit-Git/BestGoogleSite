          ...
          {images.length === 0 ? (
            ...
            >
              ...
              <label htmlFor="file-upload" className="cursor-pointer">
                <FaFileImage className="mx-auto h-12 w-12 mt-4 text-gray-400 dark:text-gray-500" />
                <div className="mt-4">
                  <span className="mt-2 block text-sm font-medium text-gray-900 dark:text-gray-300">
                    Drop your images here or
                    <span className="text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 ml-1">
                      browse
                    </span>
                  </span>
                  <p className="mt-1 text-xs mb-4 text-gray-500 dark:text-gray-400">
            ...
            <div className="space-y-6">
              ...
              <div className="mt-4 text-xs text-gray-500">
                <p>
                  • Images will be automatically fitted to {orientation} PDF
                  pages
                </p>
