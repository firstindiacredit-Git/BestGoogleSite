            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-white dark:bg-[#28283a] rounded-[30px] shadow-lg dark:border-none">
                    ...
                    <div className="p-6">
                        ...
                        {showBrowserWarning && (
                            <div className="mb-6 bg-amber-50 dark:bg-amber-900 border-l-4 border-amber-400 dark:border-amber-600 p-4 rounded-lg">
                                <div className="flex items-center">
                                    <svg className="h-5 w-5 text-amber-400 dark:text-amber-200" viewBox="0 0 20 20" fill="currentColor">
                                        <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                                    </svg>
                                    <p className="ml-3 text-sm text-amber-700 dark:text-amber-100">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex justify-center">
                                <button
                                    ...
                                    className="relative group px-6 py-3 bg-teal-500 dark:bg-teal-700 text-white rounded-lg hover:bg-teal-600 dark:hover:bg-teal-800 transition-colors shadow-lg flex items-center space-x-2"
                                >
                            ...
                            {isCaptured && (
                                <div className="space-y-6">
                                    {shareError && (
                                        <div className="bg-red-50 dark:bg-red-900 border-l-4 border-red-400 dark:border-red-600 p-4 rounded-lg">
                                            <div className="flex">
                                                ...
                                                <div className="ml-3">
                                                    <p className="text-sm text-red-700 dark:text-red-100">{shareError}</p>
                                                </div>
                                                <div className="ml-auto pl-3">
                                                    <button
                                                        type="button"
                                                        className="inline-flex text-red-400 dark:text-red-200 hover:text-red-500 dark:hover:text-red-300"
                                    ...
                                    <div className="max-w-md mx-auto">
                                        ...
                                        <div className="flex gap-4">
                                            ...
                                            <select
                                                ...
                                                className="px-4 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-200 focus:border-teal-400 transition-colors"
                                            >
                                    ...
                                    <div className="flex justify-center gap-4">
                                        <button
                                            ...
                                            className="inline-flex items-center px-4 py-2 bg-blue-500 dark:bg-blue-700 text-white rounded-lg hover:bg-blue-600 dark:hover:bg-blue-800 transition-colors"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="inline-flex items-center px-4 py-2 bg-purple-500 dark:bg-purple-700 text-white rounded-lg hover:bg-purple-600 dark:hover:bg-purple-800 transition-colors"
                                        >
                                            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
