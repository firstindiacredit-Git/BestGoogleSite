        ...
        >
          ...
          <div className="p-6">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold dark:text-gray-200 text-gray-900">Unlock PDF</h1>
              <p className="mt-2 text-sm dark:text-gray-300 text-gray-600">Remove password protection from your PDF document</p>
            </div>
              ...
              >
                ...
                >
                  ...
                  <div className="mt-4">
                    ...
                    <p className="mt-1 text-xs text-gray-500 dark:text-gray-300 mb-4">Password protected PDF files only</p>
                  </div>
                </label>
              </div>
            ) : (
              <div className="space-y-6">
                <div className="flex justify-between items-center pb-4 border-b">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-sm font-medium dark:text-gray-200 text-gray-900">{file.name}</h3>
