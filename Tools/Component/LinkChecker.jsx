...
const LinkChecker = () => {
    ...
    for (let link of links) {
      ...
      try {
        const response = await axios.get(
          proxyUrl + encodeURIComponent(urlWithoutFragment),
          {
            timeout: 10000,
        ...
        if (
          ...
          response.data.status.http_code >= 200 &&
          response.data.status.http_code < 500
        ) {
          working.push(link);
        } else {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#28283a] pt-16">
      <div className="container mx-auto max-w-4xl dark:bg-[#513a7a] rounded-lg   px-4 py-8">
        <Back />
        ...
        <div>
          ...
          <form onSubmit={handleSubmit} className="mb-12">
            <div className="flex flex-col md:flex-row gap-4 p-6 bg-white rounded-xl shadow-lg dark:bg-[#28283a]">
              <input
                type="text"
                value={url}
