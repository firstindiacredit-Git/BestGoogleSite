...
import { getPageLayout, updatePageLayout } from "../firebase/widgetLayouts";
import { getAvailableWidgets } from "../firebase/widgetLayouts";
import { DeleteOutlined, PlusOutlined } from '@ant-design/icons';

const PopularBookmarks = ({ backgroundImage }) => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onAuthStateChanged(authInstance, async (currentUser) => {
      setUser(currentUser);
      if (currentUser) {
        const layout = await getPageLayout(currentUser.uid, 'popularBookmarks');
  ...
  const handleApplySorting = async () => {
    ...
    await updatePageLayout(user.uid, 'popularBookmarks', {
      widgets: sortedItems,
