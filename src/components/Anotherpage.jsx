    ...
    <div style={{ position: "relative" }}>
      <div className="flex justify-center">
        <div className={`flex flex-col items-center w-full rounded-xl`}>
          {!user && (
            <div className="w-full mb-4 px-4 py-2 bg-yellow-50 dark:bg-yellow-900/30 border-l-4 border-yellow-400 dark:border-yellow-600">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <svg
                    className="w-5 h-5 text-yellow-400 dark:text-yellow-600 mr-3"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
                  ...
                  <p className="text-sm text-yellow-700 dark:text-yellow-200">
                    ...
                    saved locally and may be lost when clearing browser data.
                  </p>
                </div>
                <a
                  href="/signin"
                  className="ml-4 text-sm font-medium text-yellow-700 dark:text-yellow-200 hover:text-yellow-600 dark:hover:text-yellow-300 underline"
                >
                  Sign in
                </a>
              </div>
