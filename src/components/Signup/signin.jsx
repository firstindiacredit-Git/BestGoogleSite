    ...
    <div>
      ...
      {showProfessionModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-opacity-90 z-[9999]">
          <div className="bg-white p-8 rounded-3xl shadow-2xl border border-blue-100 max-w-2xl w-full animate-fade-in flex flex-col items-center">
      ...
      {showInterestModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-blue-100 via-white to-purple-100 bg-opacity-90 z-[9999]">
          <div className="bg-white p-8 rounded-3xl shadow-2xl border border-blue-100 max-w-2xl w-full animate-fade-in flex flex-col items-center">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 mb-6 w-full">
