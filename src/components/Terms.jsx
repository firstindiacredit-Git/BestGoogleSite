  ...
  const sections = [
    {
      ...
      content: `By installing and using Browsey's browser extension, you acknowledge that you have read, understood, and agree to be bound by these Terms of Use. If you do not agree to these terms, please uninstall the extension and discontinue its use.

These terms constitute a legally binding agreement between you and Browsey regarding your use of our AI-powered browser extension and related services.`,
    },
    {
...
• Email: support@browsey.ai
• Visit: www.browsey.ai/contact
• GitHub: github.com/browsey
