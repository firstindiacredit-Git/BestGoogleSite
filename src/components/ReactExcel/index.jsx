  ...
  return (
    <div className="flex flex-col space-y-4">
      {tables.map((table, index) => (
        <div
          key={table.id}
          className={`bg-white dark:bg-[#513a7a] rounded-sm shadow-md overflow-hidden ${
      ...
      <button
        onClick={handleAddTable}
        className="w-full py-2 bg-indigo-500 text-white rounded-sm hover:bg-indigo-600 transition-colors"
      >
        Add Table
      </button>
    </div>
