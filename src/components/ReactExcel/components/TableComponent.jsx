        ...
        return (
          ...
          >
            {isEditing ? (
              <input
                autoFocus
                className="absolute inset-0 w-full h-full px-2 py-1 border-2 border-blue-500 focus:outline-none dark:bg-[#513a7a] dark:text-white"
                value={cellValue}
          ...
          {headerGroups.map((headerGroup, groupIndex) => {
            ...
            return (
              <tr key={key} {...headerGroupProps} className="group">
                <th className="w-10 px-2 py-1 bg-gray-100 dark:bg-[#513a7a] text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  #
                </th>
                {headerGroup.headers.map((column, index) => {
                  ...
                  return (
                    <th
                      key={key}
                      {...columnProps}
                      className="px-2 py-1 bg-gray-100 dark:bg-[#513a7a] text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider group relative"
                    >
          ...
          {rows.map(row => {
            ...
            return (
              <tr key={key} {...rowProps} className="group">
                <td className="relative w-10 px-2 py-1 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-[#513a7a]">
