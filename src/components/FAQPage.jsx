      ...
      questions: [
        {
          ...
          answer: "BGS is a Chrome extension designed specifically for Gen Z users to enhance their Google search experience with modern features, AI-powered suggestions, and a sleek interface."
        },
        {
          question: "How do I install BGS?",
          answer: "Simply click the 'Add to Chrome' button at the top of the page, and follow the Chrome Web Store installation prompts. The extension will be ready to use immediately after installation."
        },
        {
          question: "Is BGS free to use?",
          answer: "Yes! BGS offers a free tier with essential features. We also offer Pro and Enterprise plans for users who want access to advanced features and capabilities."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: "BGS enhances Google with Gen Z-focused features like AI-powered suggestions, custom themes, advanced filters, and a modern interface designed for today's digital natives."
        },
        {
          question: "Can I use BGS on multiple devices?",
          answer: "Yes! Pro and Enterprise users can sync their BGS settings and preferences across multiple devices. Free users are limited to one device."
        },
        {
          question: "Does BGS work with other search engines?",
          answer: "Currently, BGS is designed specifically to enhance Google Search. We're exploring possibilities to support other search engines in the future."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: "Absolutely! We take privacy seriously. BGS doesn't store your search history or personal data. All features work locally on your device or through secure, encrypted connections."
        },
        {
          question: "Does BGS collect any user data?",
          answer: "We collect minimal anonymous usage data to improve our service. This never includes personal information or search queries. You can opt out of analytics in settings."
        },
        {
          question: "How does BGS handle my privacy?",
          answer: "BGS follows strict privacy guidelines. We don't sell user data, don't track individual users, and all features are designed with privacy-first principles."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: "Visit our pricing page, select the Pro plan, and follow the simple checkout process. Your account will be upgraded instantly after payment."
        },
        {
          question: "What payment methods do you accept?",
          answer: "We accept all major credit cards, PayPal, and various cryptocurrency options for maximum flexibility."
        },
        {
      ...
      questions: [
        {
          ...
          answer: "We offer multiple support channels: in-app help center, email support, and community forums. Pro users get priority support with faster response times."
        },
        {
        ...
        },
        {
          ...
          answer: "Yes! We have an active community forum where users can share tips, ask questions, and connect with other BGS users."
        }
      ]
    }
  ];
