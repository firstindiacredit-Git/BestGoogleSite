...
const Privacy = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <Box
        sx={{
          background: "linear-gradient(135deg, #6366f1 0%, #3949ab 220%)",
          color: "white",
          pt: { xs: 10, md: 15 },
          pb: { xs: 8, md: 12 },
          position: "relative",
      ...
      >
        ...
        <Container maxWidth="lg">
          <Box sx={{ position: "relative", zIndex: 2 }}>
            ...
            >
              Your privacy is our top priority. Learn how we protect and manage
              your data.
            </Typography>
          </Box>
        </Container>
            ...
            >
                ...
                >
                  ...
                  >
                    ...
                    {index === sections.length - 1 && (
                      <UpdateIcon sx={{ mr: 2, color: "#6366f1" }} />
                    )}
                    <Typography
                      variant="h5"
                      sx={{
              ...
              <Box
                sx={{
                  ...
                  borderRadius: 2,
                  background:
                    "linear-gradient(135deg, #6366f1 0%, #3949ab 220%)",
                  color: "white",
                  position: "relative",
                  overflow: "hidden",
                }}
                ...
                <Box sx={{ position: "relative", zIndex: 2 }}>
                  ...
                  >
                    <a href="mailto:support@bestgooglesite.com">
                      <ChevronRightIcon /> support@AllMyTab.com
                    </a>
                  </Typography>
                </Box>
...
const sections = [
  {
    ...
    content:
      "Welcome to AllMyTab, your AI-powered browser extension. We respect your privacy and are committed to protecting your personal data. This privacy policy explains how we collect, use, and safeguard your information when you use our browser extension.",
  },
  {
    title: "2. Information We Collect",
    content:
      "We collect and process the following information:\n\n\n • Browser activity data (URLs visited, search queries)\n\n • Extension settings and preferences\n\n • Optional account information (if you choose to create one)\n\n • Technical information (browser type, version)\n\n • Usage statistics (how you interact with our extension)",
  },
  {
    title: "3. How We Use Your Information",
    content:
      "We use your information to:\n\n\n • Power the AI features of our extension\n\n • Improve search and browsing suggestions\n\n • Enhance the extension's functionality\n\n • Provide personalized experiences\n\n • Fix bugs and technical issues\n\n • Analyze usage patterns to improve our service",
  },
  {
    title: "4. Data Security",
    content:
      "We implement industry-standard security measures to protect your browsing data and personal information. This includes encryption, secure processing, and strict access controls. Your data is processed locally when possible, and any cloud processing is done with maximum security measures in place.",
  },
  {
    title: "5. Data Sharing and Disclosure",
    content:
      "We do not sell your browsing data or personal information. We may share data with:\n\n\n • Our AI processing partners (in anonymized form)\n\n • Service providers who help operate our extension\n\n • Legal authorities when required by law\n\n • Third parties with your explicit consent",
  },
  {
    title: "6. Your Rights",
    content:
      "You have the right to:\n\n\n • Access your stored browsing data\n\n • Delete your browsing history and preferences\n\n • Opt-out of AI-powered features\n\n • Control what data is collected\n\n • Export your data\n\n • Delete your account and all associated data",
  },
  {
    title: "7. Cookies and Storage",
    content:
      "Our extension uses local storage and cookies to improve your browsing experience. You can clear this data at any time through the extension settings or your browser preferences.",
  },
  {
